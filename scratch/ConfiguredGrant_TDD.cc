...
main (int argc, char *argv[]){
  ...
  //BWP 1 (UL)
    uint16_t numerologyBwp1 = 1;    //1//0
    uint32_t udpPacketSize = 25;//10 //20 //85 //udp + 22//70
    uint32_t udpPacketSize_2 = 25;
    double centralFrequencyBand1 = 3550e6;//2595e6
    double bandwidthBand1 = 20e6;//10e6//200e6 //20e6

    uint8_t period = uint8_t(10);


    uint16_t gNbNum = 1;//1
    uint16_t ueNumPergNb = 15; //20//10
    bool enableUl = true;
    uint32_t nPackets = 100;//100 //1000
    ...
    if (scheduler_CG)
      {
        ...
        nrHelper->SetUeMacAttribute ("CGPeriod", UintegerValue (10)); //10 //Debería ser el trafficPeriod no cgPeriod
        // PHY
        nrHelper->SetUePhyAttribute ("ConfigurationTime", UintegerValue (30));
        nrHelper->SetUePhyAttribute ("CGPeriod", UintegerValue (10)); //10
      ...
      {
        //nrHelper-> SetSchedulerType(BooleanValue (false));
  ...
  //  Ptr<MyModel> modelDL = CreateObject<MyModel> ();
    ...
    /*Ptr<MyModel> modelUl_16 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_17 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_18 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_19 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_20 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_21 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_22 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_23 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_24 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_25 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_26 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_27 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_28 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_29 = CreateObject<MyModel> ();
    Ptr<MyModel> modelUl_30 = CreateObject<MyModel> ();*/


    // Setup configuration from gNB to UE in order to execute DL transmissions
   // modelDL -> Setup(enbNetDev.Get(0), ueNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));


    // Setup configuration from UE to gNB in order to execute UL transmissions
    /*modelUl_1 -> Setup(ueNetDev.Get(0), enbNetDev.Get(0)->GetAddress(), 10, nPackets, DataRate("1Mbps")); //1Mbps
    modelUl_2 -> Setup(ueNetDev.Get(1), enbNetDev.Get(0)->GetAddress(), 20, nPackets, DataRate("1Mbps"));
    modelUl_3 -> Setup(ueNetDev.Get(2), enbNetDev.Get(0)->GetAddress(), 30, nPackets, DataRate("1Mbps"));
    modelUl_4 -> Setup(ueNetDev.Get(3), enbNetDev.Get(0)->GetAddress(), 40, nPackets, DataRate("1Mbps"));
    modelUl_5 -> Setup(ueNetDev.Get(4), enbNetDev.Get(0)->GetAddress(), 50, nPackets, DataRate("1Mbps"));
    modelUl_6 -> Setup(ueNetDev.Get(5), enbNetDev.Get(0)->GetAddress(), 60, nPackets, DataRate("1Mbps"));
    modelUl_7 -> Setup(ueNetDev.Get(6), enbNetDev.Get(0)->GetAddress(), 70, nPackets, DataRate("1Mbps"));
    modelUl_8 -> Setup(ueNetDev.Get(7), enbNetDev.Get(0)->GetAddress(), 80, nPackets, DataRate("1Mbps"));
    modelUl_9 -> Setup(ueNetDev.Get(8), enbNetDev.Get(0)->GetAddress(), 90, nPackets, DataRate("1Mbps"));
    modelUl_10 -> Setup(ueNetDev.Get(9), enbNetDev.Get(0)->GetAddress(), 100, nPackets, DataRate("1Mbps"));
    modelUl_11 -> Setup(ueNetDev.Get(10), enbNetDev.Get(0)->GetAddress(), 110, nPackets, DataRate("1Mbps")); //110
    modelUl_12 -> Setup(ueNetDev.Get(11), enbNetDev.Get(0)->GetAddress(), 120, nPackets, DataRate("1Mbps"));
    modelUl_13 -> Setup(ueNetDev.Get(12), enbNetDev.Get(0)->GetAddress(), 130, nPackets, DataRate("1Mbps"));
    modelUl_14 -> Setup(ueNetDev.Get(13), enbNetDev.Get(0)->GetAddress(), 140, nPackets, DataRate("1Mbps"));
    modelUl_15 -> Setup(ueNetDev.Get(14), enbNetDev.Get(0)->GetAddress(), 150, nPackets, DataRate("1Mbps"));*/
    ...
    /*modelUl_16 -> Setup(ueNetDev.Get(15), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_17 -> Setup(ueNetDev.Get(16), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_18 -> Setup(ueNetDev.Get(17), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_19 -> Setup(ueNetDev.Get(18), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_20 -> Setup(ueNetDev.Get(19), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_21 -> Setup(ueNetDev.Get(20), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_22 -> Setup(ueNetDev.Get(21), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_23 -> Setup(ueNetDev.Get(22), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_24 -> Setup(ueNetDev.Get(23), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_25 -> Setup(ueNetDev.Get(24), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_26 -> Setup(ueNetDev.Get(25), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_27 -> Setup(ueNetDev.Get(26), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_28 -> Setup(ueNetDev.Get(27), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_29 -> Setup(ueNetDev.Get(28), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));
    modelUl_30 -> Setup(ueNetDev.Get(29), enbNetDev.Get(0)->GetAddress(), udpPacketSize, nPackets, DataRate("1Mbps"));*/


   // Simulator::Schedule(Seconds(0.099625), &StartApplication, modelDL); //0.099875


    //Different periodicities
/*    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_1);
    Simulator::Schedule(Seconds(0.1005), &StartApplicationUl, modelUl_2);
    Simulator::Schedule(Seconds(0.101), &StartApplicationUl, modelUl_3);
    Simulator::Schedule(Seconds(0.1015), &StartApplicationUl, modelUl_4);
    Simulator::Schedule(Seconds(0.102), &StartApplicationUl, modelUl_5);
    Simulator::Schedule(Seconds(0.1025), &StartApplicationUl, modelUl_6);
    Simulator::Schedule(Seconds(0.103), &StartApplicationUl, modelUl_7);
    Simulator::Schedule(Seconds(0.1035), &StartApplicationUl, modelUl_8);
    Simulator::Schedule(Seconds(0.104), &StartApplicationUl, modelUl_9);
    Simulator::Schedule(Seconds(0.1045), &StartApplicationUl, modelUl_10);*/



    // Schedule the event of Start Application
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_1);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_2);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_3);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_4);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_5);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_6);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_7);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_8);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_9);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_10);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_11);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_12);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_13);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_14);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_15);
    /*Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_16);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_17);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_18);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_19);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_20);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_21);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_22);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_23);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_24);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_25);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_26);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_27);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_28);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_29);
    Simulator::Schedule(Seconds(0.1), &StartApplicationUl, modelUl_30);*/
